...
public static Boolean checkUser(int id, String username, Role role) {
    try {
        ...
        while (scanner.hasNextLine()) {
            ...
            System.out.println("Parsed ID: " + attributes[0] + " Expected ID: " + id);  // Debug: Check parsed vs expected ID
            System.out.println("Parsed Username: " + attributes[1] + " Expected Username: " + username);  // Debug: Username
            System.out.println("Parsed Role: " + attributes[6] + " Expected Role: " + role);  // Debug: Role

            if (attributes[0].equals(String.valueOf(id)) &&
                attributes[1].equalsIgnoreCase(username) &&
